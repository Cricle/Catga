...
### 🌐 分布式与集群支持 (核心能力) ⭐
**Catga 原生支持分布式部署和集群模式**：
- **NATS 集群**: 3+ 节点高可用，自动故障转移，负载均衡
- **Redis 集群**: 主从复制，自动分片，Sentinel/Cluster 模式
- **水平扩展**: 近线性扩展 (85-100% 效率)，支持 2-200+ 副本
- **Kubernetes 原生**: HPA 自动扩缩容，健康检查，滚动更新
- **跨区域部署**: 支持多数据中心，地理分布式
- **高可用**: 99.9%+ 可用性，< 5 秒故障恢复
- **详细说明**: 查看 [DISTRIBUTED_CLUSTER_SUPPORT.md](DISTRIBUTED_CLUSTER_SUPPORT.md)
