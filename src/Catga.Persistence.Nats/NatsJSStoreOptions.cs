...
public class NatsJSStoreOptions
{
    ...
    public string StreamName { get; set; } = NatsStreamNames.DefaultPrefix;
    ...
    public string IdempotencyStreamName { get; set; } = NatsStreamNames.Idempotency;
    ...
    public string DlqStreamName { get; set; } = NatsStreamNames.DeadLetterQueue;

    /// <summary>Stream name for inbox store. Default: CATGA_INBOX.</summary>
    public string InboxStreamName { get; set; } = NatsStreamNames.Inbox;

    /// <summary>Stream name for outbox store. Default: CATGA_OUTBOX.</summary>
    public string OutboxStreamName { get; set; } = NatsStreamNames.Outbox;
