...
public class FlowStateGenerator : IIncrementalGenerator
{
    ...
    {
        // Register FlowState attribute
        context.RegisterPostInitializationOutput(ctx =>
        {
            ctx.AddSource("FlowStateAttribute.g.cs", SourceText.From(AttributeSource, Encoding.UTF8));
        });
...
/// <summary>
/// Marks a partial class to generate IFlowState implementation with change tracking.
/// </summary>
/// <example>
/// [FlowState]
...
/// }
/// // Generated: IFlowState implementation with change tracking
/// </example>
[System.AttributeUsage(System.AttributeTargets.Class, AllowMultiple = false)]
public sealed class FlowStateAttribute : System.Attribute
{
}

/// <summary>
/// Marks a property to be excluded from change tracking.
/// </summary>
[System.AttributeUsage(System.AttributeTargets.Property, AllowMultiple = false)]
public sealed class FlowStateIgnoreAttribute : System.Attribute
{
}
";
