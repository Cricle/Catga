...
public static partial class CatgaLog
{
    ...
    public static partial void MessagePublishing(ILogger logger, string messageType, string? messageId, string qoS);
    ...
    public static partial void MessagePublished(ILogger logger, string messageType, string? messageId, double durationMs);
    ...
    public static partial void MessagePublishFailed(ILogger logger, Exception? exception, string messageType, string? messageId, string error);

    [LoggerMessage(EventId = 1003, Level = LogLevel.Debug, Message = "Message received {MessageType} [MessageId={MessageId}]")]
    public static partial void MessageReceived(ILogger logger, string messageType, string? messageId);
    ...
    public static partial void CommandExecuting(ILogger logger, string commandType, string? messageId, string? correlationId);
    ...
    public static partial void CommandExecuted(ILogger logger, string commandType, string? messageId, double durationMs, bool success);

    [LoggerMessage(EventId = 2002, Level = LogLevel.Error, Message = "Command failed {CommandType} [MessageId={MessageId}, Error={Error}]")]
    public static partial void CommandFailed(ILogger logger, Exception? exception, string commandType, string? messageId, string error);
    ...
    public static partial void QueryExecuting(ILogger logger, string queryType, string? messageId, string? correlationId);
    ...
    public static partial void QueryExecuted(ILogger logger, string queryType, string? messageId, double durationMs);

    // Event Logs
    [LoggerMessage(EventId = 3000, Level = LogLevel.Debug, Message = "Publishing event {EventType} [MessageId={MessageId}]")]
    public static partial void EventPublishing(ILogger logger, string eventType, string? messageId);
    ...
    public static partial void EventPublished(ILogger logger, string eventType, string? messageId, int handlerCount);
    ...
    public static partial void EventHandlerFailed(ILogger logger, Exception exception, string eventType, string? messageId, string handlerType);
    ...
    public static partial void MessageIdempotent(ILogger logger, string messageId);

    [LoggerMessage(EventId = 5001, Level = LogLevel.Debug, Message = "Caching result for message {MessageId}")]
    public static partial void ResultCached(ILogger logger, string messageId);
    ...
    public static partial void MessageMovedToDLQ(ILogger logger, string messageType, string messageId, string reason, int retryCount);
