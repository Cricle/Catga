...
public class OutboxBehaviorV2<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
    where TRequest : class, IRequest<TResponse>
{
    private readonly IOutboxStore? _persistence;           // 存储层
    private readonly IMessageTransport? _transport;       // 传输层
    private readonly IMessageSerializer? _serializer;
    private readonly ILogger<OutboxBehaviorV2<TRequest, TResponse>> _logger;

    public OutboxBehaviorV2(
        ILogger<OutboxBehaviorV2<TRequest, TResponse>> logger,
