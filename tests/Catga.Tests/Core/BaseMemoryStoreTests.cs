...
public class BaseMemoryStoreTests
{
    ...
    public void AddOrUpdateMessage_ShouldAddNewMessage()
    {
        ...
        var message = new TestMessage { Id = "msg-1", Data = "test data" };
    ...
    public void AddOrUpdateMessage_ShouldUpdateExistingMessage()
    {
        // Arrange
        var store = new TestMemoryStore();
        var message1 = new TestMessage { Id = "msg-1", Data = "original" };
        var message2 = new TestMessage { Id = "msg-1", Data = "updated" };
    ...
    public void GetAllMessages_ShouldReturnAllMessages()
    {
        // Arrange
        var store = new TestMemoryStore();
        store.AddOrUpdate("msg-1", new TestMessage { Id = "msg-1", Data = "data1" });
        store.AddOrUpdate("msg-2", new TestMessage { Id = "msg-2", Data = "data2" });
        store.AddOrUpdate("msg-3", new TestMessage { Id = "msg-3", Data = "data3" });
    ...
    public void GetMessagesByPredicate_ShouldFilterCorrectly()
    {
        // Arrange
        var store = new TestMemoryStore();
        store.AddOrUpdate("msg-1", new TestMessage { Id = "msg-1", Data = "test", Priority = 1 });
        store.AddOrUpdate("msg-2", new TestMessage { Id = "msg-2", Data = "test", Priority = 2 });
        store.AddOrUpdate("msg-3", new TestMessage { Id = "msg-3", Data = "other", Priority = 3 });
    ...
    public void GetMessagesByPredicate_WithComparer_ShouldSortCorrectly()
    {
        // Arrange
        var store = new TestMemoryStore();
        store.AddOrUpdate("msg-1", new TestMessage { Id = "msg-1", Priority = 3 });
        store.AddOrUpdate("msg-2", new TestMessage { Id = "msg-2", Priority = 1 });
        store.AddOrUpdate("msg-3", new TestMessage { Id = "msg-3", Priority = 2 });
    ...
    public void GetCountByPredicate_ShouldCountCorrectly()
    {
        // Arrange
        var store = new TestMemoryStore();
        store.AddOrUpdate("msg-1", new TestMessage { Id = "msg-1", Data = "test" });
        store.AddOrUpdate("msg-2", new TestMessage { Id = "msg-2", Data = "test" });
        store.AddOrUpdate("msg-3", new TestMessage { Id = "msg-3", Data = "other" });
    ...
    public async Task ExecuteIfExistsAsync_WhenExists_ShouldExecuteAction()
    {
        // Arrange
        var store = new TestMemoryStore();
        var message = new TestMessage { Id = "msg-1", Data = "original" };
        store.AddOrUpdate(message.Id, message);
